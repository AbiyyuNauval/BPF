...
<head>
    ...
    <style>
        ...
        .register-card { /* Changed from login-card for clarity */
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6"> @if ($errors->any())
            ...
            <div class="card register-card">
                ...
                <div class="card-body">
                    <form action="/auth/register" method="POST"> @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            <label for="tglLahir" class="form-label">Date of Birth</label>
